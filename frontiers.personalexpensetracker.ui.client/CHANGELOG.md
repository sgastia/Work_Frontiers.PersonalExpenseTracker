...
- Create Angular project with ng: `ng new frontiers.personalexpensetracker.ui.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`frontiers.personalexpensetracker.ui.client.esproj`).
